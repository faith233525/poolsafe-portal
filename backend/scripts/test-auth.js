...
async function testAuthentication() {
    ...
    try {
        ...
        const partnerLoginResponse = await (0, node_fetch_1.default)(`${API_BASE}/auth/login/partner`, {
            method: "POST",
        ...
        const partnerLogin = await partnerLoginResponse.json();
        if (partnerLogin.token) {
            ...
            const partnerDataResponse = await (0, node_fetch_1.default)(`${API_BASE}/partners`, {
                headers: {
        ...
        const supportLoginResponse = await (0, node_fetch_1.default)(`${API_BASE}/auth/login/partner`, {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify({
        ...
        if (supportLogin.token) {
            ...
            const allPartnersResponse = await (0, node_fetch_1.default)(`${API_BASE}/partners`, {
                headers: {
        ...
        const unauthorizedResponse = await (0, node_fetch_1.default)(`${API_BASE}/users`);
