  ...
  const renderUserInfo = () => {
        ...
        <div className={styles.userInfo}>
          <div className={styles.companyInfo}>
            ...
            <p className={styles.managementCompany}>
              {partner.managementCompany && <span>Managed by {partner.managementCompany}</span>}
            </p>
    ...
    return (
      <div className={styles.userInfo}>
        ...
        <div className={styles.userRole}>
          <span
            className={`${styles.roleBadge} ${user.role?.toLowerCase() === "admin" ? styles.admin : styles.support}`}
          >
        ...
        <div className={styles.brandSection}>
          <div className={styles.logoContainer}>
            ...
            <div className={styles.brandText}>
              <h1 className={styles.title}>LounGenie</h1>
